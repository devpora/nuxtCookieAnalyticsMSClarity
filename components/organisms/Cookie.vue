...
<template>
  <div class="w-full fixed bottom-0">
    <div
        v-if="isOpen"
        class="px-4 md:px-40 pb-2 md:pb-12">
      <ULandingCard
          v-if="!isSettingsOpen"
          color="primary"
      ...
      >
        ...
        <template #description>
          Cookies enhance your experience on our site. By clicking 'Agree' or continuing to browse, you consent to their
          use.
        </template>
        <div class="">
          <div class="flex flex-col items-center gap-2">
            <UButton block class="w-1/2" variant="link" @click="isSettingsOpen = true">Settings</UButton>
            <UButton block class="w-1/2 justify-content-center" @click="saveAll()">Accept</UButton>
          </div>
        </div>
      </ULandingCard>
      <ULandingCard
      ...
      >
        ...
        <template #description>
          Our website uses cookies to ensure its proper functioning and to enhance your user experience. Some of these
          cookies are essential for the functionality of the site, while others help us analyze how you use the site.
        ...
        <div>
          ...
          <div class="pt-4 pb-8">
            <span class="text-gray-900 dark:text-white text-base font-bold">
          ...
          <div class="flex flex-row items-center gap-2">
            <UButton class="w-1/2  justify-center" variant="link" @click="saveSelected()">Save selected</UButton>
            <UButton class="w-1/2 justify-center" @click="saveAll()">Save All</UButton>
          </div>
        </div>
      </ULandingCard>
    </div>
